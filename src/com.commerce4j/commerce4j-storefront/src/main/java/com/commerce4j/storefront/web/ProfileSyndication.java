...
/**
 * Profile API, users and profile management related web syndication.
 *
 * @author carlos.quijano
 * @version $Revision$ $Date$
 * @param <M> The parameterized return model type.
 */
public interface ProfileSyndication<M> {
	 ...
	 */
	public M register(HttpServletRequest request, HttpServletResponse response);
}
